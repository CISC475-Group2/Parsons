...
class ProblemTest(TestCase):
    ...
    def test_initial_data(self):
        ...
        """
        p1 = Problem(pk=1, solution='(+ 3 (- 2 5))', points=4, compiles_to='0')
        p1_initial_data = {}
        p1_initial_data['problem_number'] = 1
        p1_initial_data['solution'] = '(+ 3 (- 2 5))'
        p1_initial_data['blocks'] = [['(', '<nt>', '<nt>', '<nt>', ')'], ['+'], ['3'], ['(', '<nt>', '<nt>', '<nt>', ')'], ['-'], ['2'], ['5']]
        p1_initial_data['compiles_to'] = '0'

        p2 = Problem(pk=2131312, solution='(+ (- 3 2) (* 2 5))', points=6, compiles_to='11')
        p2_initial_data = {}
        ...
        p2_initial_data['compiles_to'] = '11'
